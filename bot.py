...
def get_kelola_grup_submenu(huruf):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton(f"1. Admin grup - {huruf}", callback_data=f"set_admin_grup_{huruf}")],
        [InlineKeyboardButton(f"2. Anggota grup - {huruf}", callback_data=f"set_anggota_grup_{huruf}")],
        [InlineKeyboardButton(f"3. Tampilkan semua ID - {huruf}", callback_data=f"tampil_id_grup_{huruf}")],
        [InlineKeyboardButton(f"4. Hapus ID - {huruf}", callback_data=f"hapus_id_grup_{huruf}")],
        [InlineKeyboardButton(f"5. TAMBAH ADMIN - {huruf}", callback_data=f"tambah_admin_grup_{huruf}")],
        [InlineKeyboardButton("6. Kembali", callback_data="menu_admin")]
    ])
