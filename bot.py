...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_profil":
        ...
        # User klik DATA GRUP - tampilkan daftar grup A-O untuk diisi
        # Cek akses user
